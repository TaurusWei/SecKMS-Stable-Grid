 ...
 */
@Data
@ApiModel(value = "SynthetizeKeyModel",description = "密钥合成实体")
public class SynthetizeKeyModel {
   ...
   @ApiModelProperty(value = "密钥名称",  name = "name", example = "testKeyName", hidden = false)
   String name;
   ...
   @ApiModelProperty(value = "业务系统Id",  name = "appId", example = "testAppId", hidden = false)
   String appId;
   ...
   int keySize;
   @NotEmpty(message = "Key components can not be null.")
   @ApiModelProperty(value = "密钥分量",  name = "keySize", example = "[\"aVsbG8=\",\" d29ybGQ=\",\" YmFkbWb24=\",” dGVDE=”, “dGVzdDEyMjIy”]", hidden = false)

...
//  密钥模块
	...
	public static CodeMsg CREATE_SYMM_KEY_ERROR = new CodeMsg(500503, "Create symmetric key error：%s");
	public static CodeMsg SYNTH_SYMM_KEY_ERROR = new CodeMsg(500504, "Synthetize symmetric key error：%s");
	public static CodeMsg ACTIVATE_KEY_ERROR = new CodeMsg(500505, "Activate key error：%s");
	public static CodeMsg DESTROY_KEY_ERROR = new CodeMsg(500506, "Destroy key error：%s");
	public static CodeMsg DELETE_KEY_ERROR = new CodeMsg(500507, "Delete key error：%s");
	public static CodeMsg UPDATE_KEY_ERROR = new CodeMsg(500508, "Update key error：%s");
	public static CodeMsg REVOKE_KEY_ERROR = new CodeMsg(500509, "Revoke key error：%s");
	public static CodeMsg FIND_KEY_ERROR = new CodeMsg(500510, "Find key error：%s");
	public static CodeMsg LIST_KEY_ERROR = new CodeMsg(500511, "List keys error：%s");
	public static CodeMsg LIST_HISTORY_KEY_ERROR = new CodeMsg(500512, "List history keys error：%s");
